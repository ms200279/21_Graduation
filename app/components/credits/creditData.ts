...
export const creditFragments: CreditFragmentData[] = [
  ...
  },
  {
    ...
    title: "웹사이트 제작후기",
    description: [
      "안녕하세요, 21대 준비위원회의 웹사이트 기획, 디자인, 구현을 담당한 웹사이트 팀 김민석입니다.",
      ...
      "제가 고민하고 구현한 이 웹사이트를 하나의 감각으로 전달할 기회가 되어 영광입니다. 앞으로 저마다의 감각을 찾아 나갈 모든 졸업 예정자분들과, 고생하신 21대 준비위원회 구성원분들, 교내 교수진분들에게 좋은 일만 가득하길 바라며 제작 후기 마치겠습니다.",
      "감사합니다.",
    ],
    scale: 1,
    selectedScale: 1.06,
